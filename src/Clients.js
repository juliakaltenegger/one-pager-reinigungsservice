  ...
  return (
    <div classname="clients" id="clients">
      ...
      <div classname="client-corporate">
        ...
        <p>
          „Adriana Reinigungsservice begleitet uns seit 2013. Ihr Team ist super
          organisiert und sehr freundlich. Auf Adriana ist immer Verlass. Danke
          dafür!“ CORPORATE MATTERS GMBH
        </p>
      </div>
      ...
      <div classname="client-aneli">
        ...
        <p>
          ...
          Seminarräume. Da es jeden Tag mindestens 3 Seminare mit 10 Teilnehmern
          gibt und diese Stunden dauern können war es uns sehr wichtig, dass die
          Reinigungsfirma höchst zuverlässig und vertrauensvoll ist. Mit Adriana
          haben wir die perfekte Reinigungskraft gefunden. Wir sind höchst
          zufrieden. Das Team ist freundlich und sehr angenehm....“ aneli
          Ausbildungszentrum
        </p>
      </div>
      <div classname="ordination-beckmann">
        <img src="" alt="" />
        <p>
          „Adrianas Reinigungsservice reinigt seit 2012 unsere Räumlichkeiten.“
          Ordination Dr. Elmar Beckmann, Psychiatrie
        </p>
      </div>
    </div>
  );
